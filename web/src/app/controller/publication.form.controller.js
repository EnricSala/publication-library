class PublicationFormController {
...
PublicationFormController.$inject = [
  '$mdDialog', 'Publications', 'Authors', 'Publishers', 'init', 'readonly'
];
export default PublicationFormController;
